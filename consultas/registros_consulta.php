...
// funcoes ----------------------------------------------------
     ...
     // função para mostrar a tabela de consulta com os respectivos filtros ---------------------------------------------------------------
                                            ...
                                            var out = "<h2>Registros</h2><table id='tblEditavel' class='bordasimples' align='center' width='70%' >";
    ...
    lista_referencia_esp();
                 ...
                 $('#referencia').on("change", function(){  //filtra a referencia especifica a partir de uma referencia
                  ...
                  if(value_referencia == 0){lista_referencia_esp();}else{lista_filt_ref_esp(value_referencia_esp);}
